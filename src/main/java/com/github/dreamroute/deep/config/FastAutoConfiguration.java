...
public class FastAutoConfiguration implements InitializingBean {
    ...
    public FastAutoConfiguration(MybatisProperties properties, ObjectProvider<Interceptor[]> interceptorsProvider,
